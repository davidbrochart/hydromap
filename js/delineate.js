...
(function() {
  ...
  do_delineate = function*(p) {
    var cb, dir_back, dir_next, done, go_down, i, k, l, latlng, m, nb, neighbors_new, outlet, outletLayer, ref, ref1, ret, save, skip, this_tile, this_watershed, url;
    latlng = p[0];
    save = p[1];
    cb = p[2];
    if (save) {
