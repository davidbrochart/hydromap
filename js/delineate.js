...
(function() {
  var addPixel, find1, getTile, get_url, go_get_dir, go_get_dir_async, map, map_on_click, neighbors, neighbors_i, neighbors_memsize, outlet, pack_size, pix_deg, pix_deg2, pix_i, polyLayers, polygons, processTile, processTile_async, round, run, tile_width, tiles, url, wait, x, x_deg, y, y_deg;
  ...
  run = function*() {
    ...
    return (yield processTile_async());
  };
