...
(function() {
  var addLayer, extend_lineBuffer, find1, getTile, get_url, go_get_dir, layers, map, map_on_click, mm, mx, mx0, mx0_deg, mx1, mxw, my, my0, my0_deg, my1, myw, nbline_max, neighbors, neighbors_i, neighbors_memsize, outlet, p_getTile, p_wait, pack_size, pix_deg, pix_deg2, pix_i, pol_i, polyLayers, polygonize, polygons, processTile, round, run, runGen, spin_opts, spin_target, spinner, tile_width, tiles, watershed, x, x_deg, y, y_deg;
