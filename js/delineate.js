...
(function() {
  ...
  do_delineate = function*(p) {
    var acc, acc_tile, dir_back, dir_next, dir_tile, done, go_down, i, k, l, latlng, m, n, nb, neighbors_new, o, outletLayer, q, r, reached_upper_ws, ref, ref1, ref2, ref3, ref4, ref5, ret, skip, subOutletLayer, this_acc, this_accDelta, this_outlet, this_subOutlet, url;
    latlng = p;
    if (state === 'wsOnStr') {
    ...
    if (state === 'watershed' || state === 'subWs') {
    ...
    while (!done) {
      ...
      if (!skip) {
        if (state === 'wsOnStr' && (mm[my * mxw + Math.floor(mx / 8)] >> (mx % 8)) & 1 === 1) {
