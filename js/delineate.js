...
(function() {
  var addPixel, find1, getTile, get_url, go_get_dir, map, map_on_click, neighbors, outlet, pix_deg, pix_deg2, polygon1, polygon2, processTile, round, run, skip, spin_opts, spin_target, spinner, sum, tile_width, tiles, url, watershedLayer, x, x_deg, y, y_deg;
  ...
  processTile = function*() {
    while ((yield Q.async(addPixel)())) {
      null;
    }
  };

  addPixel = function*() {
    var dir_back, dir_next, done, go_down, i, j, nb, outletLayer, pixel;
    if (!skip) {
      pixel = turf.polygon([[[x_deg - pix_deg2, y_deg - pix_deg2], [x_deg - pix_deg2, y_deg + pix_deg2], [x_deg + pix_deg2, y_deg + pix_deg2], [x_deg + pix_deg2, y_deg - pix_deg2], [x_deg - pix_deg2, y_deg - pix_deg2]]]);
      polygon1.push(pixel);
  ...
  map_on_click = function(evt) {
    ...
    polygon1 = [turf.polygon([[[x_deg - pix_deg2, y_deg - pix_deg2], [x_deg - pix_deg2, y_deg + pix_deg2], [x_deg + pix_deg2, y_deg + pix_deg2], [x_deg + pix_deg2, y_deg - pix_deg2], [x_deg - pix_deg2, y_deg - pix_deg2]]])];
