...
(function() {
  var addPixel, find1, getTile, get_url, go_get_dir, map, map_on_click, neighbors, outlet, pix_deg, pix_deg2, polygon1, polygon2, processTile, round, run, skip, sum, tile_width, tiles, url, wait, watershedLayer, x, x_deg, y, y_deg;
